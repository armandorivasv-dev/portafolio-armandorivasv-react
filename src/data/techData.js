const techData = [
  ...
  },
  {
    ...
    icon: "js_badge",
    message:
      "Escribo código de manera casi autónoma solamente revisando la documentación para algunos métodos.",
  },
  {
    title: "MUI / Boostrap",
    icon: "bootstrap",
    message:
      "Utilizo Bootstrap y Material UI para dar estilos a los desarrollos en HTML y React",
  },
  ...
  },
  {
    ...
    icon: "css3",
    message:
      "Escribo código de manera casi autónoma, solamente utilizando la documentación para algunas cosas.",
  },
  {
    title: "GIT / GitHub",
    icon: "github_badge",
  ...
  },
  {
    ...
    icon: "illustrator",
    message:
      "Utilizo Illustrator para crear diseños en formato vector para desarrollar imagenes SVG, Photoshop para editar imagenes y XD/Figma para crear los wireframes.",
  },
  {
    title: "WordPress",
    icon: "wordpress",
    message:
      "Desarrollo sitios web multipropósito y tiendas virtuales funcionales totalmente administrables con Wordpress, Woocommerce y Elementor basado en un wireframe, prototipo u otro sitio similar, integración con plataformas de pagos, envíos y chats.",
  },
];
