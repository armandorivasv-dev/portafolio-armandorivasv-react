...
import logo from "../../assets/logo-armandorivasv-dev.png";
import { Link } from "react-scroll";
import { useState } from "react";
import ButtonColor from "../ChangeColor/ButtonColor";

const pages = ["tecnologias", "aptitudes", "portafolio", "contacto"];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Link to="navbar" spy={true} smooth={true} offset={-70}>
            <Box
              component="img"
              sx={{ width: 70, display: { xs: "none", md: "flex" } }}
              src={logo}
            />
          </Link>
          ...
          <Link to="navbar" spy={true} smooth={true} offset={-70}>
            <Box
              component="img"
              sx={{ width: 40, mr: 1, display: { xs: "flex", md: "none" } }}
              src={logo}
            />
          </Link>
